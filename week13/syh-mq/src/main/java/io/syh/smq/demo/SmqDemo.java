...
public class SmqDemo {
    ...
    public static void main(String[] args) {
        ...
        SmqConsumer consumer = broker.createConsumer();
        consumer.subscribe(topic);
        final boolean[] flag = new boolean[1];
        flag[0] = true;
        new Thread(() -> {
            while (flag[0]) {
                SmqMessage<Order> message = consumer.poll(100);
                if(null != message) {
        ...
        while (true) {
            ...
            if(c > 20) {
                ...
                producer.send(topic, new SmqMessage(null, new Order(100000L + c, System.currentTimeMillis(), "USD2CNY", 6.52d)));
            }
